...
> Refit the whale-blow mixture (morning Problem 3) in Nimble with no ordering constraint. Explain why $\hat R$ explodes despite convergence; propose three fixes with limitations; discuss the bias of post hoc relabeling. (Conceptual; a short Nimble demonstration is optional.)

**My work:**

```{r}
# Your R code here (optional demonstration)
```
