...
Open this `.Rmd` from inside the course project (`FW536.Rproj`) so the
`here::here()` paths find the data.
...
sock <- read.csv(here::here("Day2_GLM", "data", "sockeye_adult.csv"), stringsAsFactors = FALSE)
...
- [ ] Loaded `data/sockeye_adult.csv` for Problem 4 (with the course project open).
