...
# Problem 5 · Simulating no interaction
...
> and explain why the two are not exactly equal. (e) With the interaction
> coefficient set to zero, name the shape of the fitted surface and describe its
> contour lines.
...
# Problem 6 · Simulating an interaction
...
# Problem 7 · The interaction you did not put in the model
...
eta <- -1 + 1.2*d7$x1 - 0.8*d7$x2      # no x1*x2 term
